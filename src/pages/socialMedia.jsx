...
import degitalMarketingPerson from "../assets/images/happyBussinessmanImg.png";
            ...
            <div className="flex justify-center lg:justify-end relative lg:-mt-12 order-2">
              <div className="relative flex items-end">
                ...
                <img
                  ...
                  className="relative z-10 w-56 sm:w-72 md:w-80 lg:w-[520px] object-contain translate-x-6"
                />
              </div>
            </div>
