...
export default function HomePage() {
      ...
      <section className="relative bg-sidebar min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-20">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl pt-24 font-bold text-sidebar-foreground mb-4 sm:mb-6 leading-tight">
            ...
            <span className="">India For Your Successful Business!</span>
          </h1>
  ...
  rounded-full bg-[#FE4C1C] text-white font-semibold shadow-lg 
  overflow-hidden transition-all duration-300
  border-2 border-transparent hover:border-white hover:bg-transparent hover:text-white"
            >
              {/* Glow effect */}
              <span className="absolute inset-0 rounded-full bg-[#FE4C1C] blur-xl opacity-40"></span>
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between h-[90vh] w-[90%] px-6 md:px-16 py-10 bg-[#f3f0f0] gap-12">
          ...
          <div className="max-w-md md:max-w-xl text-left md:text-left">
            ...
            <button className="relative group flex items-center justify-center px-5 py-2 font-semibold border border-black overflow-hidden">
              <span className="absolute inset-0 bg-[#FE4C1C] w-1/2 group-hover:w-full transition-all duration-500"></span>
              ...
              >
                <div className="p-5 flex flex-col items-center text-center">
                  ...
                  <div className="relative mb-3">
                    <div className="w-12 h-12 bg-[#FE4C1C] rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
      ...
      <section className="py-16 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center justify-center w-12 h-12 bg-[#FE4C1C] rounded-2xl mb-4 shadow-md">
              <Quote className="w-6 h-6 text-white" />
            </div>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-3">
              Customer Reviews
            </h2>
            <div className="w-20 h-1 bg-[#FE4C1C] mx-auto rounded-full"></div>
                  ...
                  >
                    <div className="bg-white rounded-xl p-6 shadow-md border border-gray-200 text-center h-full hover:shadow-lg transition-all">
                      ...
                      <div className="flex justify-center mb-3">
                        <div className="w-8 h-8 bg-[#FE4C1C] rounded-full flex items-center justify-center shadow-sm">
                      ...
                      <div className="flex justify-center mb-3">
                        {[...Array(testimonial.rating)].map((_, i) => (
                          <Star
                            key={i}
                            className="w-5 h-5 fill-[#FE4C1C] text-[#FE4C1C] mx-0.5"
                          />
                        ))}
                      </div>
                      ...
                      <div className="flex items-center justify-center space-x-3">
                        <img
                          ...
                          className="w-12 h-12 rounded-full object-cover border-2 border-[#FE4C1C]"
                        />
