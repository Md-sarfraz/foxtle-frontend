  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-50 
        ...
        ${scrolled ? "bg-black py-3" : "bg-white/5 py-6"}`}
    >
          ...
          <ul className="absolute top-full left-0 w-full bg-white/10 backdrop-blur-md rounded-b-xl shadow-lg flex flex-col items-center gap-4 mt-2 py-4 text-gray-200 font-medium text-sm z-40">
            <li>
              <Link
                to="/about"
                onClick={() => setIsOpen(false)}
                className={`pb-1 ${isActive("/about") ? "border-b-2 border-white" : ""
                  }`}
              >
                About Us
              </Link>
            ...
            <li>
              <Link
                to="/products"
                onClick={() => setIsOpen(false)}
                className={`pb-1 ${isActive("/products") ? "border-b-2 border-white" : ""
                  }`}
              >
                Products
              </Link>
            ...
            <li>
              <Link
                to="/blogs"
                onClick={() => setIsOpen(false)}
                className={`pb-1 ${isActive("/blogs") ? "border-b-2 border-white" : ""
                  }`}
              >
                Blogs
              </Link>
            ...
            <Link
              to="/features"
              className={`block w-full text-center py-2 hover:text-white ${isActive("/features") ? "border-b-2 border-white" : ""
                }`}
              onClick={() => setIsOpen(false)}
            >
              View Features
        ...
        <div className="hidden lg:flex items-center justify-between w-full">
          ...
          <ul className="flex items-center gap-6 text-gray-200 font-normal text-sm">
            <li>
              <Link
                to="/about"
                className={`transition-colors duration-300 hover:text-white pb-1 ${isActive("/about") ? "border-b-2 border-white" : ""
                  }`}
              >
                About Us
              </Link>
            ...
            <li
              ...
              onMouseLeave={() => setIsServiceOpen(false)}
            >
              <button className="flex items-center gap-1 group-hover:text-white pb-1">
                Services <ChevronDown size={16} />
              </button>
              {isServiceOpen && (
                <ul className="absolute left-0 mt-2 w-48 bg-white/10 backdrop-blur-md rounded-md shadow-lg py-2">
            ...
            <li>
              <Link
                to="/products"
                className={`hover:text-white pb-1 ${isActive("/products") ? "border-b-2 border-white" : ""
                  }`}
              >
                Products
              </Link>
            ...
            <li>
              <Link
                to="/blogs"
                className={`hover:text-white pb-1 ${isActive("/blogs") ? "border-b-2 border-white" : ""
                  }`}
              >
                Blogs
              </Link>
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2 flex flex-col items-center gap-0.5">
            <Link to="/" className="flex flex-col items-center">
              <img
                src={foxtleLogo}
                alt="Foxtle Logo"
                className={`object-contain cursor-pointer transition-all duration-300 ${scrolled ? "h-6 w-6" : "h-8 w-8"
                  }`}
              />
          ...
          <div className="flex items-center gap-4 text-sm">
            <Link
              to="/contact"
              className={`bg-white/10 hover:bg-white/20 text-gray-200 px-3 py-2  font-medium transition 
